...
import com.test.alecarballo.demo.userservice.impl.UserServicesImpl;
import com.test.alecarballo.demo.ws.exceptions.UserServicesException;
...
public class UserController {
	...
	public ResponseEntity<UserRest> getUser(@PathVariable String userID) {
		...
		if(true) throw new UserServicesException("A user service exception is thrown");
